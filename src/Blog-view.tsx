...
export function BlogView({ isOpen, onClose, blogpost }: BlogViewProps) {
    ...
    return (
        <div className="fixed inset-0 z-10 flex justify-end">
            ...
            <div className="w-full md:w-full h-full bg-white dark:bg-[#191919] flex flex-col">
                <div className='h-10 dark:bg-white bg-[#191919] flex items-center'>
                    <button onClick={onClose} className="p-2  text-white dark:text-black">✕ Close</button>
                </div>
                <div className="flex-1 min-h-0 overflow-y-auto p-4">
                    <div className="prose max-w-4xl dark:prose-invert mx-auto">
                        <p className="text-black dark:text-white text-6xl mb-0">{parsedblogpost?.title}</p>
